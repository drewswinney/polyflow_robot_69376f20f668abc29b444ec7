{ config, pkgs, lib, webrtcPkg, pyEnv, robotConsoleStatic, robotApiPkg, rosWorkspace, ... }:

let
  user      = "admin";
  password  = "password";
  hostname  = "69376f20f668abc29b444ec7";
  homeDir   = "/home/${user}";
  ...
  workspaceRuntimeInputs = rosRuntimePackages ++ [ pyEnv rosWorkspace ];
